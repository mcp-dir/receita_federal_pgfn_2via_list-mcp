...
Receita Federal: PGFN (CND Federal) - Lista Segunda Via segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [receita_federal_pgfn_2via_list@mcp.ai](mailto:receita_federal_pgfn_2via_list@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
